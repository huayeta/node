 ...
 * @param num 截取多少个字符
 */
template.helper('toLimit', function (str, num) {
	str=str.replace(/<[^>].*?>/g,"");
	str=str.replace(/(&#60;)(?!&#62;).*?(&#62;)/g,"");
	if(str.length>num){
